...
const createResultado = async(req=request,res=response)=>{
    const {pacientes,idTipoExamen,  ResultadoExamen, ValorPagado, Observaciones } =  req.body;
    
    const Resultadosave = new Resultados({ pacientes, idTipoExamen,  ResultadoExamen, ValorPagado, Observaciones})
...
const updateResultado = async(req,res =  response)=>{
    ...
    res.json(`Se ha editado el resultado`);
